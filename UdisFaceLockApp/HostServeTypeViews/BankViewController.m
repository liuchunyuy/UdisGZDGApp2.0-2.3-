...
- (void)viewDidLoad {
    ...
    _nameArr = @[@"招商银行",@"中国银行",@"中国建设银行",@"中国工商银行",@"中信银行",@"浦发银行",@"中国农业银行",@"中国民生银行",@"光大银行",@"交通银行",@"兴业银行",@"邮政储蓄银行"];
    _numArr = @[@"95555",@"95566",@"95533",@"95588",@"95558",@"95528",@"95599",@"95568",@"95595",@"95559",@"95561",@"95580"];
