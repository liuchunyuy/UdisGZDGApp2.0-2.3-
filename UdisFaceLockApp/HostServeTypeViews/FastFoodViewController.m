...
@interface FastFoodViewController ()<UITableViewDelegate,UITableViewDataSource>
...
- (void)viewDidLoad {
    ...
    _nameArr = @[@"麦当劳",@"必胜客",@"丽华快餐",@"肯德基",@"真功夫",@"永和大王"];
    _numArr = @[@"4008517517",@"4008123123",@"4008800400",@"4008823823",@"4006927927",@"4000979797"];
