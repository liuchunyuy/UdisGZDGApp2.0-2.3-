//
//  SportsTipsViewController.m
//  UdisFaceLockApp
//
//  Created by GavinHe on 16/12/19.
//  Copyright © 2016年 chen. All rights reserved.
//

#import "SportsTipsViewController.h"

@interface SportsTipsViewController ()

@end

@implementation SportsTipsViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.navigationItem.title = @"步行小贴士";
